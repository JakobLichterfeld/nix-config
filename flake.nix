{
  ...
  inputs = {
    ...
    nixpkgs-darwin.url = "github:nixos/nixpkgs?rev=8f49bca3dc47f48ef46511613450364fd82b0b36"; # https://github.com/NixOS/nixpkgs/issues/420134#issuecomment-3032188749
