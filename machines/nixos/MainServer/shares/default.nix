...
services.samba = {
  ...
  extraConfig = ''
    workgroup = WORKGROUP
    server string = ${imputs.machines.MainServer.hostName}
    netbios name = ${imputs.machines.MainServer.hostName}
    security = user
    hosts allow = 192.168.1.0/24 ${imputs.machines.MainServer.ipNetwork}
